...
require('lazy').setup({
  ...
  -- better surrounding object support
  'tpope/vim-surround',
...
end, { desc = '[F]ind current [S]election' })
...
require('nvim-treesitter.configs').setup {
  ...
  ensure_installed = { 'c', 'cpp', 'go', 'lua', 'python', 'rust', 'tsx', 'typescript', 'help', 'vim', 'kotlin', 'hcl', 'json', 'jsonnet' },
